...
| **Phase C** | お知らせセクション | 未着手 |
| **Phase D** | Instagramセクション | 未着手 |
...
**目的**: お知らせ（ニュース）セクションを実装する。ヒーローの次に表示。

## C-1. お知らせ

- [ ] セクション構成・背景（デザインに合わせて緑 or 白など）
- [ ] セクションタイトル（例: 「お知らせ」）
- [ ] お知らせカード（日付・タイトル・抜粋等）
- [ ] 一覧リンク・MORE ボタン（必要に応じて）

---

# Phase D: Instagramセクション

**目的**: Instagram フィードまたはリンクを表示するセクションを実装する。

## D-1. Instagram

- [ ] セクション構成・背景
- [ ] セクションタイトル
- [ ] Instagram 埋め込み or 画像グリッド or プロフィールリンク（仕様に応じて）
- [ ] アカウントリンク（必要に応じて）
