	...
	<div class="l-container">
		<section class="p-archive p-archive--news">
			<header class="p-archive__header">
				<h1 class="p-archive__title"><?php the_archive_title(); ?></h1>
				<?php if ( get_the_archive_description() ) : ?>
					<div class="p-archive__description"><?php the_archive_description(); ?></div>
				<?php endif; ?>
			</header>
			...
			<div class="p-archive__grid p-news__grid">
				...
				if ( have_posts() ) :
					...
					?>
					<p class="p-archive__empty">該当するお知らせはありません。</p>
				<?php endif; ?>
			</div>
